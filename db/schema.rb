...
ActiveRecord::Schema.define(:version => 20130417173726) do
  ...
  create_table "blog_posts", :force => true do |t|
    ...
    t.timestamp "coverphoto_updated_at"
    t.boolean   "locations_linked"
  end
  ...
  create_table "profiles", :force => true do |t|
    ...
    t.timestamp "created_at",               :null => false
    t.timestamp "updated_at",               :null => false
    t.string    "profpicture_file_name"
    t.string    "profpicture_content_type"
    t.integer   "profpicture_file_size"
    t.timestamp "profpicture_updated_at"
    t.integer   "user_id"
    t.text      "notes"
  end
